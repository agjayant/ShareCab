...
urlpatterns = patterns('',
   ...
   url(r'^update', 'sharecabapp.views.update', name='update'),
   ...
   url(r'^review', 'sharecabapp.views.review', name='review'),
   url(r'^rating', 'sharecabapp.views.rating', name='rating'),
   url(r'^profile', 'sharecabapp.views.profile', name='profile'),
   url(r'^drivers', 'sharecabapp.views.drivers', name='drivers'),
   url(r'^delete/?P<id>([0-9]+)/$', 'sharecabapp.views.delete', name='delete'),
   url(r'^drivReviews/?P<mobile>([0-9]+)/$', 'sharecabapp.views.drivReviews', name='drivReviews'),
   url(r'^edit/?P<id>([0-9]+)/$', 'sharecabapp.views.edit', name='edit'),
